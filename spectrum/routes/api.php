...
Route::middleware(['throttle:6600,1'])->group(function () {
    ...
    Route::get('/students/{id}', [App\Http\Controllers\Api\V1\StudentController::class, 'show']); // Fetch a single therapist by ID
    Route::post('/students', [App\Http\Controllers\Api\V1\StudentController::class, 'store']); // Create a new therapist
    Route::put('/students/{id}', [App\Http\Controllers\Api\V1\StudentController::class, 'update']); // Update an existing therapist
    Route::delete('/students/{id}', [App\Http\Controllers\Api\V1\StudentController::class, 'destroy']); // Delete a therapist
    //Therapist Routes
